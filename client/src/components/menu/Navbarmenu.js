        ...
        <div className="container">
            <div className="row">
                ...
                <div className="header__middle__menus">
                    ...
                    <li onClick={toggleSubmenu} className="menu-item sub__menus__arrows" > <Link to="#"> Study Material <FiChevronDown /> </Link>
                        ...
                        <li  className="menu-item" >
                            <NavLink exact activeClassName='is-active' onClick={toggleClass} to={`/StudyRoom`}> Study Room</NavLink> 
                        </li>
